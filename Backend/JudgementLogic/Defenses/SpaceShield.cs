...
{
    public class scaceShield : DefenseBase
    {
        public override DefenseName Name { get; set; } = DefenseName.scaceShield;
        ...
        public override float Work(Body source, Body owner, float attack, AttackType type)
        {
            ...
            owner.GainResource(ResourceType.Time, resistent / (float)10f);
